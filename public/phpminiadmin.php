...
*/
 ...
 $ACCESS_PWD='zH5vZ7pH7bwS6h'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

 #DEFAULT db connection settings
 # --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
 $DBDEF=array(
 'user'=>"testmcpe",#required
 'pwd'=>"zH5vZ7pH7bwS6h", #required
 'db'=>"testmcpe",  #optional, default DB
