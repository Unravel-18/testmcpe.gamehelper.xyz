...
<a href="{{ route('skins.add', ['api_id' => $itemapi->id]) }}" type="button" class="btn btn-primary px-5 btn-my">Add</a>
</div>
<div style="float: left;margin-right: 3px;">
								...
								<tbody>
                                    ...
                                    <tr class="tr-item" data-id="{{ $item->id }}">
                                       ...
                                       <td valign="middle" align="center">{{ $item->price }}</td>
                                        <td style="width: 42px;" align="center" valign="middle"><a href="{{ route('skins.edit', ['id' => $item->id, 'api_id' => $itemapi->id]) }}"><i style="font-size: 16px;" class="fa fa-cog" aria-hidden="true"></i></a></td>
                                        <td style="width: 42px;" align="center" valign="middle"><a href="javascript:;" onclick="confirmClick(this)" data-href="{{ route('skins.delete', ['id' => $item->id, 'api_id' => $itemapi->id]) }}"><i style="font-size: 16px;" class="fa fa-trash" aria-hidden="true"></i></a></td>
									</tr>
                                    @endforeach
								</tfoot>
							</table>
...
function clickDisplaceItem(obj) {
    ...
    $.ajax({
		    	...
		    	url: "{{route('skins.displace_sort_2')}}",
		    	data: {
